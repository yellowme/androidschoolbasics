...
function verifyExercise (exe) {
  return new Promise(function (resolve, reject) {
    controller.getResultsTest('ListViewTest').then(function (results) {
...
function getMessage (message, language) {
  ...
  } else if (message.indexOf('junit.framework.ComparisonFailure') === 0 || message.indexOf('junit.framework.AssertionFailedError') === 0) {
